...
describe('Landing Page Example Test', () => {
  context(
    'These are the example tests for the landing page for: baseUrl - https://the-internet.herokuapp.com/',
    () => {
      ...
      it('should click the form authentication link and navigate to the /login page', () => {
        landingPage.navigateTo();
        landingPage
          .containsText('a', landingPage.FORM_AUTHENTICATION_LINK_TEXT)
          .click();
